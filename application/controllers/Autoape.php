 ...
 * @license         MIT
 */
class Autoape extends Base_controller
{
    ...
    public function getNearby($lat, $lng, $radius, $page = 1)
    {
        ...
        foreach ($objVehNew as $key) {
            ...
            $key->distance = $array['dealership_info']->distance;
    ...
    public function findDealershipById($id, $page = 1)
    {
        ...
        $array['dealer']  = $this->Maxauto_Model->selectDealershipById($id, $logged_code);
        $dealerName =   $array['dealer'][0]->dealership_name;
        $dealerImage = $array['dealer'][0]->rec_img_base64;
    ...
    public function upload_dealership()
    {
        $data["data"] = $this->Maxauto_Model->selectAllDealership();
        $this->load->view("maxauto/dealership", $data);
    }
    ...
    {
        $result = $this->Maxauto_Model->deleteDealership($id);
        redirect('Autoape/upload_dealership');
    }
    ...
    public function addDealership()
    {
        $dealer["dealership_name"] = $this->input->post_get('dealername');
        $dealer["dealership_website"] = $this->input->post_get('dealerweb');
        $dealer["delete_flag"] = 1;
        $result = $this->Maxauto_Model->createDealersip($dealer);
        redirect('Autoape/upload_dealership');
    }
