                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <select name="business" class="form-control">
                                                    <option value="0" selected="">Choose Business Group</option>
                                                    <?php
                                                    foreach ($business as $key2) {
                                                    ?>
                                                        <option value="<?= $key2->business_id ?>"><?= $key2->business_name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <li class="list-group-item p-3" style="border-bottom: 0;">
                        ...
                        <div style="margin-top:100px" class="row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <img style="width:200px;height:100px;margin-top: 15px;" id="blah2" />
