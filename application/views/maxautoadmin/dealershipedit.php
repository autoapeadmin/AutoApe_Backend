                    ...
                    <li class="list-group-item p-3" style="border-bottom: 0;">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <?php
                                $b64image = base64_encode(file_get_contents("https://maxauto.s3-ap-southeast-2.amazonaws.com/maxauto/dealership/logo/" . $dealer[0]->img_base64));
                                $b64image2 = base64_encode(file_get_contents("https://maxauto.s3-ap-southeast-2.amazonaws.com/maxauto/dealership/logo/" . $dealer[0]->rec_img_base64));
                                ?>

                                <input value="data:image/png;base64,<?= $b64image ?>" type='hidden' name="imageCroped" id="imageCroped"> 


                                <img src="https://maxauto.s3-ap-southeast-2.amazonaws.com/maxauto/dealership/logo/<?= $dealer[0]->img_base64 ?>" style="width:100px;height:100px;margin-top: 15px;" id="blah" />
                        ...
                        <div style="margin-top:100px" class="row">
                            <div class="col-sm-12 col-md-6">
                                <strong class="text-muted d-block mb-2">Logo Image Rectangular</strong>
                                <div class="form-group">
                                    <input accept="image/*" onchange="readURL2(this);" type="file" class="form-control-file" name="images2" id="images2">
                                </div>

                                 <input value="data:image/png;base64,<?= $b64image2 ?>" type='hidden' name="imageCroped2" id="imageCroped2"> 
                               
                                <img src="https://maxauto.s3-ap-southeast-2.amazonaws.com/maxauto/dealership/logo/<?= $dealer[0]->rec_img_base64 ?>" style="width:220px;height:60px;margin-top: 15px;" id="blah2" />

                                <a class="upload-result2 btn btn-sm btn-success ml-auto">Crop</a>
                            </div>
                            <script>
