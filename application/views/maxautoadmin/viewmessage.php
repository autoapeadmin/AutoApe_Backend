...
<div class="row">
  <div class="col-md-12">
    <div class="card card-small mb-4">
      <div class="card-header border-bottom">
        <h6 class="m-0"><?= $messages[0]->subject ?></h6>
      </div>
      <div class="card-body p-0">
          ...
          <div class="user-activity__item__icon">
            <img style="    width: 30px;" class="user-avatar rounded-circle mr-2" <?php if ($messages[0]->is_admin == 1) {
                                                                                  ?> src="/assets/img/logomsg.png" <?php
                                                                                                                  } else { ?> src="<?= $_SESSION["DEALER_LOGO"] ?>" <?php } ?> alt="User Avatar">
          </div>
        ...
        ?>
          ...
          <?php
            ...
            <div class="user-activity__item pr-3 py-3">
              <div class="user-activity__item__icon">
                <img style="width: 30px;" class="user-avatar rounded-circle mr-2" src="<?= $messages[0]->img_base64 ?>" alt="User Avatar">
              </div>
              <div class="user-activity__item__content">
                <span class="text-light"><?php echo date("D d/m/y H:i", strtotime($reply->indate)); ?></span>
                <p><?= $reply->reply ?></p>
  ...
  <div class="col-md-6">
    <form style="width: 100%;" action="/Maxautoadmin/addReply/<?= $messages[0]->message_id ?>" method="POST" enctype="multipart/form-data">
      <div class="card card-small mb-4">
        <div class="card-header border-bottom">
        ...
        <div style="margin:10px" class="card-body p-0">
          ...
          <a href="/Maxautoadmin/closeMessage/<?= $messages[0]->message_id ?>/3/1" style="margin-top:10px;right: 10px;
    position: absolute;background-color:#2e7d32;border-color: green;" class="btn btn-white active">
            Close
          </a>
